...
*
* http요청이 들어올때 jwt토큰을 확인하고 유효한 토큰의 경우
* 사용자 정보를 인증 컨텍스트에 등록하여 해당 요청이 인증된 사용자로서 처리되도록한다
* */
        ...
        try {
            ...
            if(header != null && !header.equalsIgnoreCase("")){
                ...
                if(TokenUtils.isValidToken(token)){
                    ...
                    //토큰에 담긴 정보로 member객체를 만든다
                    //(security context에 등록된 인증객체(userdetail)를 만들기 위해)
                    ...
                    // authenticationToken에 추가정보설정(IP, 세션정보)
            ...
            //exception 발생시 exception내용을 응답해준다
